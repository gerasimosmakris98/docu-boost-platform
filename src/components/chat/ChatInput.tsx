...
interface ChatInputProps {
  onSendMessage: (message: string, attachments: { url: string; type: string; name: string }[]) => void;
  isSending: boolean;
  isDisabled: boolean;
}

const ChatInput = ({ onSendMessage, isSending, isDisabled }: ChatInputProps) => {
  ...
  return (
    <div className="p-4 border-t border-gray-800 bg-gray-900/30">
      ...
      <div className="flex items-end gap-2 bg-gray-800/30 rounded-lg border border-gray-700/50 focus-within:border-green-500/50">
        ...
        <Button
          className="rounded-full h-8 w-8 flex-shrink-0 mr-1 bg-green-600 hover:bg-green-700 text-white disabled:bg-gray-700 disabled:text-gray-400"
